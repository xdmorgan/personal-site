...
We suure can, let's swap out all the HTML in our example to semantically render a table without modifying anything below the surface and keep the pagination for free 🤑
