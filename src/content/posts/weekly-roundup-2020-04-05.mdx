...
So, in an effort to make these things easier to refer back to in the future, I'm going to start publishing roundups of 5-10 resources (articles, conference talks, GitHub repos) that caught my eye. If you find yourself enjoying the content, these roundup posts are conveniently published along with the rest of my blog posts in my [site's dedicated RSS feed](/rss.xml) so smash that subscribe button, if you're into that sort of thing.
