...
export function ProjectsAndArticlesSection() {
  return (
    ...
    <section className={cx(styles.grid__projects, 'py-8x md:py-12x lg:py-16x')}>
      ...
      <div className="child-my-0 my-4x md:my-8x">
        <ul className={cx(styles.projects, 'list-reset')}>
          ...
          >
            Worked on the Swift native iOS application rewrite (previously PWA)
            for the gif-generating event photo booth start-up.
          </Project>
  ...
  return (
    <div
      className={cx(
        ...
        styles.articles,
        'pt-4x pb-8x md:py-12x lg:py-16x md:pl-4x lg:pl-8x'
      )}
    >
